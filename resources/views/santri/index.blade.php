                            ...
                            <tbody>
                                @forelse ($santris as $santri)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($santri->gambar)
                                                <img src="{{ asset('storage/images/santri/' . $santri->gambar) }}"
                                                    alt="{{ $santri->nama_santri }}" width="100">
                                            @else
                                                Tidak ada gambar
                                            @endif
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                                data-bs-target="#editSantriModal{{ $santri->id }}">
                                    ...
                                    <div class="modal fade" id="editSantriModal{{ $santri->id }}" tabindex="-1"
                                        aria-labelledby="editSantriModalLabel{{ $santri->id }}" aria-hidden="true">
                                                ...
                                                <form action="{{ route('santri.update', $santri->id) }}" method="POST"
                                                    ...
                                                    <div class="modal-header">
                                                        <h5 class="modal-title"
                                                            id="editSantriModalLabel{{ $santri->id }}">Edit Santri:
                                                            {{ $santri->nama_santri }}</h5>
                                                        ...
                                                        <div class="row mb-3">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="nama_santri" class="form-label">Nama
                                                                        Santri</label>
                                                                    <input type="text" class="form-control"
                                                                        id="nama_santri" name="nama_santri"
